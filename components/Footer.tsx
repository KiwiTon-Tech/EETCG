          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a href="mailto:info@eliteenterprisetcg.com" className="hover:text-[color:var(--color-gold)]">
            ...
            <div className="flex mt-4 space-x-4">
              <a
                href="https://www.linkedin.com/company/elite-enterprise-transformation-consulting-group"
                target="_blank"
              ...
              <a
                href="https://twitter.com/eliteenterprisetcg"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[color:var(--color-gold)]"
              ...
              <a
                href="https://www.facebook.com/eliteenterprisetcg"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-[color:var(--color-gold)]"
